...
* [runc](https://github.com/opencontainers/runc/) (not within minimal image)
...
* [Netavark](https://github.com/containers/netavark): container network stack and default in podman 5 or later
  ...
  * [aardvark-dns](https://github.com/containers/aardvark-dns) (not within minimal image)
* [catatonit](https://github.com/openSUSE/catatonit): (not within minimal image)
...
| Tag | Description |
| --- | ----------- |
| `latest`, `<VERSION>` | podman with all binaries: runc, crun, conmon, fuse-overlayfs, netavark, pasta, aardvark-dns, catatonit. |
